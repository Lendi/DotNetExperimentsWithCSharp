...
namespace asset.datalayer
{
    ...
    partial void DeleteAssetInfo(AssetInfo instance);
		...
		public assetDataContext() : 
				base(global::asset.datalayer.Properties.Settings.Default.AssetManagementConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnremarksChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_RequestInfo", Storage="_users", ThisKey="emp_id", OtherKey="emp_id", IsForeignKey=true)]
		public users users
		{
			get
			{
